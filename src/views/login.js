// 登陆页面
import { StyleSheet, Text, View, ImageBackground, Dimensions, TextInput,TouchableHighlight } from 'react-native'
...
const login = () => {
  ...
  return (
    <ImageBackground style={styles.ImageBackground} source={require('./../assets/login/loginbg.png')}>
        ...
        <View style={styles.containerTop}>
          ...
          <View style={styles.textInput}>
            ...
            {/* <Text style={styles.sortDown}>
              <Icon name='sort-down' size={20} style={styles.icon} color='#fff'></Icon>
            </Text> */}
            <TextInput 
